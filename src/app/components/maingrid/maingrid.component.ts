...
export class MaingridComponent implements OnInit, AfterViewInit {
    ...
    this.masonryItems = [
      {
        order: 1,
        name: 'imessage',
        img: '/poster/imessage.png',
        class: 'ui',
        video: '/grid/events.mp4',
        routerLink: '/events',
        url: '',
      },
      {
        order: 2,
        name: 'ideocolab',
        img: '/poster/ideocolab.png',
        class: 'development ui 3d creativecode ',
        video: '',
        routerLink: '/cryptonite',
        url: '',
      },
      {
        order: 3,
        name: 'wklymotion',
        img: '/poster/wklymotion.png',
        class: 'development creativecode 3d',
        video: '/grid/wklymotion.mp4',
        routerLink: '/wklymotion',
        url: '',
      },
      {
        order: 4,
        name: 'mello',
        img: '/poster/mello.jpeg',
        class: 'ui graphic development',
        video: '',
        routerLink: '/mello',
        url: '',
      },
      {
        order: 5,
        name: 'potter',
        img: '/poster/potter.png',
        class: 'development ui',
        video: '/grid/potter.mp4',
        routerLink: '/potter',
        url: '',
      },
      {
      ...
      },
      {
        order: 7,
        name: 'rizikitoto',
        img: '/poster/rizikitoto.png',
        class: 'development ui',
        video: '',
        routerLink: '/rizikitoto',
        url: '',
      },
      {
        order: 8,
        name: 'spotify',
        img: '/poster/spotify.png',
        class: 'ui graphic',
        video: '',
        routerLink: '/spotify',
        url: '',
      ...
      },
      {
        order: 10,
        name: 'vapor',
        img: '/poster/vapor.png',
        class: 'development',
        video: '/grid/vapor.mp4',
        routerLink: '/vaporun',
        url: '',
      },
      {
        order: 11,
        name: 'photogram',
        img: '/poster/photogram.png',
        class: '3d ui',
        video: '/grid/photogram.mp4',
        routerLink: '/photogram',
        url: '',
      },
      {
        order: 12,
        name: 'blaster',
        img: '/poster/blaster.png',
        class: 'development ui',
        video: '/grid/blaster.mp4',
        routerLink: '/blaster',
        url: '',
      },
    ];
    ...
    setTimeout(() => {
      ...
      if (checkroutes) {
        ...
        setTimeout(() => {
          ...
          const filterbtn: any = $('.filterbtn');
          const formatBtn: any = Array.from(filterbtn);
          const colletions = formatBtn.filter(x =>
            x.className.includes('is-checked'),
          );
  ...
  gridFilters(item) {
    if (item !== 'all') {
      ...
      setTimeout(() => {
        this.masonryItems = this.masonryItemsCopy.filter(items =>
          items.class.includes(item),
        );
      ...
      this.masonryItems = [];
      setTimeout(() => {
        this.masonryItems = this.masonryItemsCopy.sort(
          (a, b) => a.order - b.order,
        );
      }, 50);
    }
