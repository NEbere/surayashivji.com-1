...
@Component({
  selector: 'app-wklymotion',
  templateUrl: './wklymotion.component.html',
  styleUrls: ['./wklymotion.component.css']
})
export class WklymotionComponent implements OnInit, AfterViewInit {
